# Generated by Django 2.0.5 on 2019-01-21 12:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Docente_Materia_Grupo',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('docente_materia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='INTO.Docente_Materia')),
            ],
        ),
        migrations.CreateModel(
            name='Encargado',
