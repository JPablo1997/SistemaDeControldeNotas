# Generated by Django 2.0.5 on 2018-10-27 01:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nota', models.DecimalField(decimal_places=4, max_digits=5)),
            ],
        ),
        migrations.CreateModel(
            name='Docente',
        ...
        migrations.AddField(
            ...
            name='tipo_usuario',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='INTO.TipoUsuario'),
        ),
        migrations.AddField(
            model_name='asignaciontipousuario',
            name='usuario',
